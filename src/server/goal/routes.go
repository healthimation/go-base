...
import (
	...
	"github.com/healthimation/goal-service/src/internal/v1/goal"
	"github.com/healthimation/goal-service/src/internal/v1/test"
...
func (s *server) init() {
	...
	// Setup routes
	router.Post(s.prefixRoute("/v1/goal/:userID"), b.Measure("create goal", goal.Create(signingKey, dbFactory)))
